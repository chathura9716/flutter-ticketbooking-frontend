    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Gap(AppLayout.getHeight(25)),
          Container(
            padding: EdgeInsets.symmetric(horizontal: AppLayout.getHeight(15),vertical: AppLayout.getWidth(18)),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Take the survey about our services and get the discount',style: Styles.headLineStyle2.copyWith(fontWeight: FontWeight.w500,color: Colors.white,fontSize: 18),),
